...
class OperationalTopHeader extends StatefulWidget
...
class _OperationalTopHeaderState extends State<OperationalTopHeader> {
  ...
  Widget build(BuildContext context) {
    ...
    final showUserText = sizeClass != WindowSizeClass.compact;
            ...
            Expanded(
              ...
              child: ConstrainedBox(
                constraints: BoxConstraints(
                  maxWidth: _searchMaxWidth(context, sizeClass),
                ),
                child: TextField(
  ...
  Widget _buildAction(
    ...
    if (badge != null) {
      button = Stack(alignment: Alignment.center, children: [button, badge]);
    }
  ...
  double _searchMaxWidth(BuildContext context, WindowSizeClass sizeClass) {
    return switch (sizeClass) {
      WindowSizeClass.compact => context.space.xl * 12,
      WindowSizeClass.medium => context.space.xl * 13,
      WindowSizeClass.expanded => context.space.xl * 16,
