...
void main() {
  group('AdaptiveScaffold', () {
    testWidgets('compact (< 600): renders AppBottomBar, no NavigationRail', (
      tester,
    ) async {
    ...
    testWidgets(
      'medium (600): renders NavigationRail, extended == false, does not crash',
      (tester) async {
    ...
    testWidgets(
      'expanded (840): renders NavigationRail, extended == false, does not crash',
      (tester) async {
    ...
    testWidgets(
      'large (1200): renders NavigationRail, extended == true, labelType null/none, does not crash',
      (tester) async {
        await tester.pumpWidget(buildSubject(width: 1200, height: 800));
        final rail = tester.widget<NavigationRail>(find.byType(NavigationRail));
        expect(rail.extended, isTrue);
        final isLabelTypeValid =
            rail.labelType == null ||
    ...
    testWidgets(
      'large (1440): renders NavigationRail, extended == true, does not crash',
      (tester) async {
