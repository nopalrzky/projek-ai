...
import { EmployeeSalaryCreateProps } from "./types";
...
const EmployeeSalaryCreate = ({
    ...
    errors,
    flash,
}: EmployeeSalaryCreateProps) => {
    const { data, setData, post, processing, clearErrors } =
    ...
    const selectedSalary = salaries.find((s) => s.id === data.salaryId);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(
            route("employees.employee-salaries.store", {
    ...
    return (
        <>
            <Head title={`Tambah Gaji - ${employee.name}`} />
                ...
                <div className=" mx-auto space-y-6">
                    ...
                    >
                        <PageHeader
                            ...
                            subtitle={`Tambahkan komponen gaji untuk ${employee.name}`}
                            icon={DollarSign}
                            variant="default"
                            actions={
                                <Button
                                ...
                                <div className="space-y-6">
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            >
                                                Pilih komponen gaji dan tentukan
                                                jumlahnya
                                            </p>
                                        </div>
                                    </div>
...
EmployeeSalaryCreate.layout = (page: any) =>
