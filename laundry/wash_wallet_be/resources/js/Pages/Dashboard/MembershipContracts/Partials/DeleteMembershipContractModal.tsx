...
import { DeleteMembershipContractModalProps } from "../types";

const DeleteMembershipContractModal: React.FC<
    DeleteMembershipContractModalProps
> = ({ isOpen, membershipContract, onClose, onConfirm, isLoading }) => {
    const handleConfirm = () => {
        if (!isLoading) {
            onConfirm();
        }
...
export default DeleteMembershipContractModal;
