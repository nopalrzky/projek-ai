...
import { MembershipContractOutletProps } from "../types";

const MembershipContractOutlet: React.FC<MembershipContractOutletProps> = ({
    outlet,
}) => {
...
export default MembershipContractOutlet;
