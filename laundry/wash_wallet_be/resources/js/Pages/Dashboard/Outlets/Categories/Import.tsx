...
import { CategoryImportPageProps } from "./types";
...
function CategoryImportPage({
    ...
    config,
    flash,
}: CategoryImportPageProps) {
    const [selectedFile, setSelectedFile] = useState<File | null>(null);
    const [uploading, setUploading] = useState(false);

    const handleDownloadTemplate = useCallback(() => {
        outletService.downloadCategoryTemplate(outlet.id);
    }, [outlet.id]);
    ...
    const handleUpload = useCallback(async () => {
        ...
        try {
            await outletService.uploadCategoryImportFile(
                outlet.id,
                { file: selectedFile, type: "category" },
                {
                    onSuccess: () => {
                        console.log(
    ...
    return (
        <>
            <Head title={`Import Kategori - ${outlet.name}`} />
            <motion.div
                ...
                <div className=" mx-auto space-y-6">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-gray-600 dark:text-gray-400">
                            Import multiple categories at once using Excel
                            template
                        </p>
                    </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-blue-700 dark:text-blue-300 mb-4">
                                    ...
                                    kategori Anda, kemudian simpan file
                                    tersebut.
                                </p>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <ul className="space-y-1 text-sm text-yellow-800 dark:text-yellow-200">
                                    ...
                                    <li>
                                        • Kategori akan ditambahkan ke outlet:{" "}
                                        <strong>{outlet.name}</strong>
                                    </li>
                                    <li>
                                        • Jika nama kategori sudah ada, data
                                        akan diupdate
                                    </li>
                                    <li>
...
CategoryImportPage.layout = (page: any) => {
    const props = page.props as CategoryImportPageProps;
