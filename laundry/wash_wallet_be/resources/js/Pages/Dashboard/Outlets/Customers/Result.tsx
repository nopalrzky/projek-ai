...
import { CustomerResultPageProps } from "./types";

function CustomerResultPage({ importLog, outlet }: CustomerResultPageProps) {
    ...
    const handleDownloadErrors = () => {
        outletService.downloadCustomerImportErrors(outlet.id, importLog.id);
    };
                ...
                <div className="max-w-6xl mx-auto space-y-6">
                                ...
                                <div className="flex items-center gap-4 p-4 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="text-sm text-green-700 dark:text-green-300">
                                            {importLog.successCount} customer
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <StatsCard
                            ...
                            icon={<CheckCircle />}
                            variant="success"
                            description="Customer berhasil diimport"
                            size="md"
                            elevated
                        />
                        <StatsCard
...
CustomerResultPage.layout = (page: any) => {
    const props = page.props as CustomerResultPageProps;
    return withAuthenticatedLayout({
        title: "Hasil Import Customer",
        breadcrumbs: [
