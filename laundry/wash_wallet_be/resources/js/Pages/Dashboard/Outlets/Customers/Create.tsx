...
const OutletCustomerCreate = ({ outlet }: CustomerCreateProps) => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        post(route("outlets.customers.store", outlet.id), {
            preserveScroll: true,
            forceFormData: true,
            onError: (errors) => {
    ...
    return (
        <>
            <Head title={`Tambah Pelanggan - ${outlet.name}`} />
            ...
            >
                <div className=" mx-auto space-y-6">
                    <PageHeader
                        title={`Tambah Pelanggan - ${outlet.name}`}
                        subtitle={`Daftarkan pelanggan baru untuk outlet ${outlet.name} (${outlet.code})`}
                        icon={UserCog}
                        variant="default"
                        actions={
                            <Button
...
OutletCustomerCreate.layout = (page: any) =>
...
export default OutletCustomerCreate;
