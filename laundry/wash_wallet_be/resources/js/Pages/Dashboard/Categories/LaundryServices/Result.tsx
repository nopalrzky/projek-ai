...
import { LaundryServiceResultPageProps } from "./type";

function LaundryServiceResultPage({
    importLog,
    category,
}: LaundryServiceResultPageProps) {
    ...
    const handleDownloadErrors = () => {
        categoryService.downloadLaundryServiceImportErrors(
            category.id,
            importLog.id
        );
    };
    ...
    return (
        <>
            <Head title={`Import Result - ${category.name}`} />
                ...
                <div className="max-w-6xl mx-auto space-y-6">
                                ...
                                <div className="flex items-center gap-4 p-4 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="text-sm text-green-700 dark:text-green-300">
                                            {importLog.successCount} layanan
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <StatsCard
                            ...
                            icon={<CheckCircle />}
                            variant="success"
                            description="Layanan berhasil diimport"
                            size="md"
                            elevated
                        />
                        <StatsCard
...
LaundryServiceResultPage.layout = (page: any) => {
    const props = page.props as LaundryServiceResultPageProps;
    return withAuthenticatedLayout({
        title: "Hasil Import Layanan",
        breadcrumbs: [
...
export default LaundryServiceResultPage;
