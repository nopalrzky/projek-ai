...
namespace App\Http\Requests\Outlet\MembershipPlan;
...
class UpdateMembershipPlanRequest extends FormRequest
{
    ...
    {
        $membershipPlanId = $this->route('membership_plan');
        ...
        return [
            ...
            'level' => [
                ...
                $membershipPlan
                    ...
                    ->ignore($membershipPlanId)
                    ->where('outlet_id', $membershipPlan->outlet_id)
                    : 'integer'
            ],
        ];
    }
