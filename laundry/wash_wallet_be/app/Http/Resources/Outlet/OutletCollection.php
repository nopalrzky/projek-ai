...
class OutletCollection extends ResourceCollection
{
    ...
    public function __construct($resource, $message = null, $status = 200, $filters = [], $errors = null)
    {
        ...
        $this->message = $message ?? 'Outlets fetched successfully';
        $this->status = $status;
    ...
    private function buildFilters(Request $request): array
    {
        $filters = [
            ...
            'owner_id' => $request->get('filter.owner_id') ?? $request->get('ownerId'),

            // Location filters
            'province' => $request->get('filter.province'),
            'city' => $request->get('filter.city'),
            'district' => $request->get('filter.district'),
            'village' => $request->get('filter.village'),
            ...
            // Advanced filters
            'has_operational_days' => $request->get('filter.has_operational_days'),
            'has_categories' => $request->get('filter.has_categories'),
            'has_employees' => $request->get('filter.has_employees'),
    ...
    {
        return new self($resource, $message ?? 'Outlets fetched successfully', 200, $filters);
    }
